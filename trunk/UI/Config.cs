...
namespace RogueRaidBT.UI
{
    public partial class Config : Form
    {
        ...
        private void buttonApply_Click(object sender, EventArgs e)
        {
            ...
            {
                var input = MessageBox.Show("WARNING: You have enabled poisons for Raid mode or Arena mode. Using Apoc's Raid Bot as your botbase will result in RogueRaidBT being " +
