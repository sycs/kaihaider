    ...
    static class Subtlety
    {
        static public Composite BuildCombatBehavior()
        {
            return new PrioritySelector(
		        ...
		        Helpers.Spells.CastSelf("Recuperate",     ret => StyxWoW.Me.ComboPoints > 2 && Helpers.Rogue.mHP < 95 &&
                ...
                Helpers.Spells.Cast("Deadly Throw", ret => StyxWoW.Me.CurrentTarget != null && StyxWoW.Me.ComboPoints > 0 && StyxWoW.Me.ComboPoints < 3 && 
                                                    Helpers.Rogue.mCurrentEnergy >= 70 && !StyxWoW.Me.CurrentTarget.IsWithinMeleeRange),
