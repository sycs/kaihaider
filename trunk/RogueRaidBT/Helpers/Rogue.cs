            ...
            return new Decorator(cond,
                new PrioritySelector(
                    new Decorator(ret => Helpers.Rogue.mTarget.CanInterruptCurrentSpellCast,
                        new PrioritySelector(
                            Helpers.Spells.CastCooldown("Kick", ret => Helpers.Rogue.mTarget.Class == Styx.Combat.CombatRoutine.WoWClass.Mage ||
                                Helpers.Aura.IsTargetCasting == 5782 || Helpers.Focus.rawFocusTarget != null &&
                    ...
                    Helpers.Spells.CastCooldown("Gouge", ret => Helpers.Rogue.mCurrentEnergy > 40 && Helpers.Rogue.IsHolyOrNat() &&
