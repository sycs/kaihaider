...
namespace PallyRaidBT.Helpers
{
    class Area
    {
        ...
        static private Enumeration.LocationContext GetCurrentLocation()
        {
            ...
            //if (Battlegrounds.IsInsideBattleground && Battlegrounds.Current != Styx.Logic.BattlegroundType.AB || 
            //    Battlegrounds.Current != Styx.Logic.BattlegroundType.AV || Battlegrounds.Current != Styx.Logic.BattlegroundType.BfG ||
            //    Battlegrounds.Current != Styx.Logic.BattlegroundType.EotS ||
            //    Battlegrounds.Current != Styx.Logic.BattlegroundType.IoC || Battlegrounds.Current != Styx.Logic.BattlegroundType.SotA ||
            //    Battlegrounds.Current != Styx.Logic.BattlegroundType.TP || Battlegrounds.Current != Styx.Logic.BattlegroundType.WSG)
            {
                return Enumeration.LocationContext.Arena;
            }
