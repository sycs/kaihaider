               ...
               Helpers.Rogue.TryToInterrupt(ret => Helpers.Aura.IsTargetCasting != 0 && Helpers.Rogue.mTarget.CanInterruptCurrentSpellCast &&
                ...
                //                           Helpers.Rogue.mCurrentEnergy >= 70 && !Helpers.Aura.CripplingPoison),
                        ...
                        Helpers.Spells.Cast("Shadowstep", ret => !Helpers.Movement.IsInSafeMeleeRange
                         ...
                         Helpers.Spells.CastCooldown("Dismantle", ret => (Helpers.Rogue.mHP < 85 || 
                             Helpers.Rogue.mCurrentEnergy < 100 && !(Helpers.Aura.ShadowDance || Helpers.Aura.Stealth || Helpers.Aura.Vanish || Helpers.Aura.ShadowDance) && 
                             Helpers.Rogue.mTarget.IsPlayer && Helpers.Movement.IsInSafeMeleeRange)
                            )
                        )
                   ),
